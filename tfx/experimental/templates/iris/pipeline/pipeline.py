...
def create_pipeline(
  ...
  # TODO(step 4): Use another ExampleGen class for your data.
  ...
  # TODO(step 5): Uncomment here to add Transform to the pipeline.
  ...
  # TODO(step 7): Uncomment here to add ResolverNode to the pipeline.
  ...
  # TODO(step 7): Uncomment here to add Evaluator to the pipeline.
  ...
  # TODO(step 7): Uncomment here to add Pusher to the pipeline.
